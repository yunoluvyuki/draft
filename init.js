...
function setupSettings(){
  ...
  const FS_RULES=[
    ...
    ['#add-btn',16],['#quint-count',13],['.btm-panel-hdr',12],
    ['#specs-header .label',12],['.filter-tab',10],['.sort-btn',11],
    ['.sort-label',11],['.stat-name',16],['.stat-val',17],
    ['.card-info .stat-grid .stat-name',11],['.card-info .stat-grid .stat-val',12],
    ['#fund-header .label',11],['.fund-row',10],['#protocols-header .title',12],
    ['.protocol-title',10],['.protocol-sub',10],['.toggle-label',12],
    ['.protocol-val',8],['#battle-intro',11],['.card-name',16],
    ['.card-stats',16],['.new-badge',12],
    ['.rewards-header',12],['.reward-item',12],['.btn-challenge',12],
    ['.btn-maxed',9],['#battle-creature-name',16],['#battle-creature-tag',12],
    ['.hp-label',9],['#battle-log',9],['.battle-btn',9],['#battle-status',12],
    ...
    ['.quint-sub',8],['.quint-row',9],['#reincarnate-btn',9],['.reincarnate-req',12],
    ['.settings-row-label',10],['.settings-check-label',10],
    ['.settings-check-sublabel',8],['.zoom-val',10],['.zoom-btn',12],
  ];
