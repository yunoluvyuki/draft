...
const CREATURES = [
  // ── TIER 1 — COMMON ────────────────────────────────
  {id:'hollow_wretch',name:'HOLLOW WRETCH',tag:'Nothing left but need.',atk:2,def:1.0,hp:10,count:null,rewards:{atk:0.12,old:0.15},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'plague_hound',name:'PLAGUE HOUND',tag:'Loyal to the rot.',atk:3,def:1.1,hp:550,count:3,rewards:{hp:0.4,old:0.18},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'ashwalker',name:'ASHWALKER',tag:'Stepped out of the fire.',atk:4,def:1.1,hp:600,count:'10%',rewards:{atk:0.13,old:0.2},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'bonepicker',name:'BONEPICKER',tag:'Patience at its worst.',atk:5,def:1.2,hp:650,count:null,rewards:{old:0.22,atk:0.11},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'grave_rat',name:'GRAVE RAT',tag:'It was here first.',atk:6,def:1.2,hp:700,count:2,rewards:{hp:0.45,old:0.2},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'mudborn',name:'MUDBORN',tag:'The swamp made it.',atk:7,def:1.3,hp:750,count:'12%',rewards:{atk:0.14,old:0.24},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'corpse_crawler',name:'CORPSE CRAWLER',tag:'Moving. Somehow.',atk:8,def:1.3,hp:800,count:null,rewards:{old:0.26,hp:0.5},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'rotting_serf',name:'ROTTING SERF',tag:'Still working after death.',atk:9,def:1.4,hp:850,count:4,rewards:{atk:0.15,old:0.28},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'blighted_husk',name:'BLIGHTED HUSK',tag:'The disease won.',atk:10,def:1.4,hp:900,count:'15%',rewards:{hp:0.55,old:0.3},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'soot_fiend',name:'SOOT FIEND',tag:'Left over from something worse.',atk:11,def:1.5,hp:950,count:null,rewards:{atk:0.16,old:0.32},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'wretched_thrall',name:'WRETCHED THRALL',tag:'Serving without knowing why.',atk:13,def:1.6,hp:1000,count:3,rewards:{old:0.34,atk:0.14},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'festering_vagrant',name:'FESTERING VAGRANT',tag:'Homeless and hungry.',atk:14,def:1.6,hp:1050,count:'15%',rewards:{hp:0.6,old:0.35},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'hollow_eye',name:'HOLLOW EYE',tag:'Nothing looks back.',atk:15,def:1.7,hp:1100,count:null,rewards:{atk:0.17,old:0.37},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'dungeon_tick',name:'DUNGEON TICK',tag:'It found you.',atk:17,def:1.7,hp:1150,count:5,rewards:{old:0.4,hp:0.65},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'gravel_ghoul',name:'GRAVEL GHOUL',tag:'Dug itself out.',atk:18,def:1.8,hp:1200,count:'18%',rewards:{atk:0.18,old:0.42},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'bile_spawn',name:'BILE SPAWN',tag:'Born wrong.',atk:19,def:1.8,hp:1250,count:null,rewards:{hp:0.7,old:0.44},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'mossrot',name:'MOSSROT',tag:'Where things go to end.',atk:21,def:1.9,hp:1300,count:2,rewards:{atk:0.19,old:0.46},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'scab_crawler',name:'SCAB CRAWLER',tag:'Every wound is a door.',atk:22,def:1.9,hp:1350,count:'20%',rewards:{old:0.48,atk:0.17},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'charnel_fly',name:'CHARNEL FLY',tag:'Drawn to the smell.',atk:23,def:2.0,hp:1400,count:null,rewards:{hp:0.75,old:0.5},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'skinless_beggar',name:'SKINLESS BEGGAR',tag:'Still asking.',atk:25,def:2.0,hp:1450,count:4,rewards:{atk:0.2,old:0.52},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'weeping_hollow',name:'WEEPING HOLLOW',tag:'The grief outlasted the body.',atk:26,def:2.1,hp:1500,count:'20%',rewards:{old:0.54,hp:0.8},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'maggot_knight',name:'MAGGOT KNIGHT',tag:'Earned its title somehow.',atk:27,def:2.1,hp:1550,count:null,rewards:{atk:0.21,old:0.56},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'cinder_wretch',name:'CINDER WRETCH',tag:'Burned and kept going.',atk:29,def:2.2,hp:1600,count:3,rewards:{hp:0.85,old:0.58},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'sallow_shade',name:'SALLOW SHADE',tag:'A dim thing.',atk:30,def:2.2,hp:1650,count:'22%',rewards:{atk:0.22,old:0.6},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'mud_ghoul',name:'MUD GHOUL',tag:'Dredged from below.',atk:32,def:2.3,hp:1700,count:null,rewards:{old:0.62,hp:0.9},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'bonegnaw',name:'BONEGNAW',tag:'Always chewing.',atk:33,def:2.3,hp:1750,count:5,rewards:{atk:0.23,old:0.64},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'ashen_tramp',name:'ASHEN TRAMP',tag:'Wandered here from the ruins.',atk:34,def:2.4,hp:1800,count:'22%',rewards:{hp:0.95,old:0.66},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'foul_creeper',name:'FOUL CREEPER',tag:'Slow but certain.',atk:36,def:2.4,hp:1850,count:null,rewards:{atk:0.24,old:0.68},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'plague_bearer',name:'PLAGUE BEARER',tag:'A gift nobody wanted.',atk:37,def:2.5,hp:1900,count:2,rewards:{old:0.7,hp:1.0},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'tallow_shade',name:'TALLOW SHADE',tag:'Rendered down to spite.',atk:39,def:2.5,hp:1950,count:'25%',rewards:{atk:0.25,old:0.72},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'rot_worm',name:'ROT WORM',tag:'Patient underground.',atk:40,def:2.6,hp:2000,count:null,rewards:{hp:1.05,old:0.74},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'filth_shambler',name:'FILTH SHAMBLER',tag:'Moving against all reason.',atk:42,def:2.6,hp:2050,count:3,rewards:{atk:0.26,old:0.76},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'corpse_leech',name:'CORPSE LEECH',tag:'Takes what it needs.',atk:43,def:2.7,hp:2100,count:'25%',rewards:{old:0.78,hp:1.1},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'bleached_lurker',name:'BLEACHED LURKER',tag:'Waiting in the white.',atk:45,def:2.7,hp:2150,count:null,rewards:{atk:0.27,old:0.8},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'grave_digger',name:'GRAVE DIGGER',tag:'Finished the job, then stayed.',atk:46,def:2.8,hp:2200,count:4,rewards:{hp:1.15,old:0.82},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'putrid_wisp',name:'PUTRID WISP',tag:'Even the light here decays.',atk:48,def:2.8,hp:2250,count:'28%',rewards:{atk:0.28,old:0.84},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'wailing_husk',name:'WAILING HUSK',tag:'No one answered.',atk:49,def:2.9,hp:2300,count:null,rewards:{old:0.86,hp:1.2},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'dustbone',name:'DUSTBONE',tag:'Older than memory.',atk:51,def:2.9,hp:2350,count:2,rewards:{atk:0.29,old:0.88},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'sludge_spawn',name:'SLUDGE SPAWN',tag:'From the drain.',atk:52,def:3.0,hp:2400,count:'28%',rewards:{hp:1.25,old:0.9},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'tomb_rat',name:'TOMB RAT',tag:'It knows the tunnels.',atk:54,def:3.0,hp:2450,count:null,rewards:{atk:0.3,old:0.92},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'cracked_skull',name:'CRACKED SKULL',tag:'Still thinking.',atk:55,def:3.1,hp:2500,count:5,rewards:{old:0.94,hp:1.3},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'pale_shambler',name:'PALE SHAMBLER',tag:'Color long forgotten.',atk:57,def:3.1,hp:2550,count:'30%',rewards:{atk:0.31,old:0.96},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'rotfen_cur',name:'ROTFEN CUR',tag:'A bad dog.',atk:58,def:3.2,hp:2600,count:null,rewards:{hp:1.35,old:0.98},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'ash_crawler',name:'ASH CRAWLER',tag:'What the fire left behind.',atk:60,def:3.2,hp:2650,count:3,rewards:{atk:0.32,old:1.0},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'bonedust_wretch',name:'BONEDUST WRETCH',tag:'Powdered thin by years.',atk:61,def:3.3,hp:2700,count:'30%',rewards:{old:1.02,hp:1.4},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'famine_shade',name:'FAMINE SHADE',tag:'Wants what you have.',atk:63,def:3.3,hp:2750,count:null,rewards:{atk:0.33,old:1.04},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'cobweb_ghoul',name:'COBWEB GHOUL',tag:"Hasn't moved in ages.",atk:64,def:3.4,hp:2800,count:4,rewards:{hp:1.45,old:1.06},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'soot_crawler',name:'SOOT CRAWLER',tag:'Marks everything it touches.',atk:66,def:3.4,hp:2850,count:'32%',rewards:{atk:0.34,old:1.08},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'charred_beggar',name:'CHARRED BEGGAR',tag:'Survived the wrong things.',atk:67,def:3.5,hp:2900,count:null,rewards:{old:1.1,hp:1.5},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'hollow_pup',name:'HOLLOW PUP',tag:'Lost before it began.',atk:69,def:3.5,hp:2950,count:2,rewards:{atk:0.35,old:1.12},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'mire_fiend',name:'MIRE FIEND',tag:'Deep in the wet.',atk:70,def:3.6,hp:3000,count:'32%',rewards:{hp:1.55,old:1.14},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'ditch_ghoul',name:'DITCH GHOUL',tag:'Roadside nuisance.',atk:72,def:3.6,hp:3050,count:null,rewards:{atk:0.36,old:1.16},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'scorch_wretch',name:'SCORCH WRETCH',tag:'Too close to the heat.',atk:73,def:3.7,hp:3100,count:5,rewards:{old:1.18,hp:1.6},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'festering_hound',name:'FESTERING HOUND',tag:'It still tries to wag its tail.',atk:75,def:3.7,hp:3150,count:'35%',rewards:{atk:0.37,old:1.2},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'gutter_shade',name:'GUTTER SHADE',tag:'Lives in the runoff.',atk:76,def:3.8,hp:3200,count:null,rewards:{hp:1.65,old:1.22},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'bog_lurker',name:'BOG LURKER',tag:'Patient as the water.',atk:78,def:3.8,hp:3250,count:3,rewards:{atk:0.38,old:1.24},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'cinder_rat',name:'CINDER RAT',tag:'Small and furious.',atk:79,def:3.9,hp:3300,count:'35%',rewards:{old:1.26,hp:1.7},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'dried_husk',name:'DRIED HUSK',tag:'Just the shape of something.',atk:81,def:3.9,hp:3350,count:null,rewards:{atk:0.39,old:1.28},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'brackish_spawn',name:'BRACKISH SPAWN',tag:'Salt and rot.',atk:82,def:4.0,hp:3400,count:2,rewards:{hp:1.75,old:1.3},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'sunken_wretch',name:'SUNKEN WRETCH',tag:'Came up from below.',atk:84,def:4.0,hp:3450,count:'38%',rewards:{atk:0.4,old:1.32},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'tallow_ghoul',name:'TALLOW GHOUL',tag:'Greasy with time.',atk:85,def:4.1,hp:3500,count:null,rewards:{old:1.34,hp:1.8},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'blister_fiend',name:'BLISTER FIEND',tag:'Pressure made it awful.',atk:87,def:4.1,hp:3550,count:4,rewards:{atk:0.41,old:1.36},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'gravel_rat',name:'GRAVEL RAT',tag:'Sharp teeth, no brain.',atk:88,def:4.2,hp:3600,count:'38%',rewards:{hp:1.85,old:1.38},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'mudwater_shade',name:'MUDWATER SHADE',tag:'Visibility zero.',atk:90,def:4.2,hp:3650,count:null,rewards:{atk:0.42,old:1.4},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'pale_crawler',name:'PALE CRAWLER',tag:'Moves like doubt.',atk:91,def:4.3,hp:3700,count:3,rewards:{old:1.42,hp:1.9},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'crumbling_thrall',name:'CRUMBLING THRALL',tag:'Held together by orders.',atk:93,def:4.3,hp:3750,count:'40%',rewards:{atk:0.43,old:1.44},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'fen_ghoul',name:'FEN GHOUL',tag:'The marsh kept it.',atk:94,def:4.4,hp:3800,count:null,rewards:{hp:1.95,old:1.46},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'ashen_cur',name:'ASHEN CUR',tag:'Scorched and mean.',atk:96,def:4.4,hp:3850,count:5,rewards:{atk:0.44,old:1.48},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'charnel_rat',name:'CHARNEL RAT',tag:'Feeds on the fallen.',atk:97,def:4.5,hp:3900,count:'40%',rewards:{old:1.5,hp:2.0},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'bone_fly',name:'BONE FLY',tag:'Loud, wrong, everywhere.',atk:99,def:4.5,hp:3950,count:null,rewards:{atk:0.45,old:1.52},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'sour_shade',name:'SOUR SHADE',tag:'The taste lingers.',atk:100,def:4.6,hp:4000,count:2,rewards:{hp:2.05,old:1.54},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'rot_pup',name:'ROT PUP',tag:'Young and already ruined.',atk:102,def:4.6,hp:4100,count:'42%',rewards:{atk:0.46,old:1.56},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'crypt_tick',name:'CRYPT TICK',tag:'Found in the lining.',atk:103,def:4.7,hp:4200,count:null,rewards:{old:1.58,hp:2.1},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'damp_husk',name:'DAMP HUSK',tag:'The wet got in.',atk:105,def:4.7,hp:4300,count:4,rewards:{atk:0.47,old:1.6},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'scab_fiend',name:'SCAB FIEND',tag:'Its wounds are armor.',atk:106,def:4.8,hp:4400,count:'42%',rewards:{hp:2.15,old:1.62},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'hollow_stray',name:'HOLLOW STRAY',tag:'Looking for something gone.',atk:108,def:4.8,hp:4500,count:null,rewards:{atk:0.48,old:1.64},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'cobweb_wretch',name:'COBWEB WRETCH',tag:'Suspended in old silk.',atk:109,def:4.9,hp:4600,count:3,rewards:{old:1.66,hp:2.2},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'silt_shambler',name:'SILT SHAMBLER',tag:'The riverbed walks.',atk:111,def:4.9,hp:4800,count:'45%',rewards:{atk:0.49,old:1.68},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'dusty_ghoul',name:'DUSTY GHOUL',tag:'Settled over decades.',atk:112,def:5.0,hp:5000,count:null,rewards:{hp:2.25,old:1.7},vicReq:5,new:false,tier:1,type:'scrap'},
  {id:'hollow_shambler',name:'HOLLOW SHAMBLER',tag:'Nothing inside but hunger.',atk:114,def:5.0,hp:5200,count:'50%',rewards:{atk:0.5,old:1.72},vicReq:5,new:false,tier:1,type:'scrap'},
  // ── TIER 2 — UNCOMMON ──────────────────────────────
  {id:'cursed_knight',name:'CURSED KNIGHT',tag:'The oath became a shackle.',atk:120,def:5.5,hp:5500,count:null,rewards:{atk:0.9,old:2.0,arm:0.05},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'plague_archer',name:'PLAGUE ARCHER',tag:'Every arrow carries a diagnosis.',atk:130,def:5.8,hp:5800,count:3,rewards:{old:2.2,bronze:0.5},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'blighted_halberdier',name:'BLIGHTED HALBERDIER',tag:'Reach and ruin combined.',atk:140,def:6.1,hp:6100,count:'12%',rewards:{atk:1.0,old:2.4,arm:0.06},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'hollow_sergeant',name:'HOLLOW SERGEANT',tag:'Giving orders it cannot follow.',atk:150,def:6.4,hp:6400,count:null,rewards:{old:2.6,bronze:0.8},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'rot_shaman',name:'ROT SHAMAN',tag:'Blessed by the wrong gods.',atk:160,def:6.7,hp:6700,count:2,rewards:{atk:1.1,old:2.8,arm:0.07},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'ashbound_soldier',name:'ASHBOUND SOLDIER',tag:'Drafted after death.',atk:170,def:7.0,hp:7000,count:'15%',rewards:{old:3.0,bronze:1.0},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'bonecage_warrior',name:'BONECAGE WARRIOR',tag:'Wears its ribs outside.',atk:180,def:7.3,hp:7300,count:null,rewards:{atk:1.2,old:3.2,arm:0.08},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'gravewarden',name:'GRAVEWARDEN',tag:'Protecting the wrong side.',atk:190,def:7.6,hp:7600,count:4,rewards:{old:3.4,bronze:1.2},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'fetid_executioner',name:'FETID EXECUTIONER',tag:'Justice went rancid.',atk:200,def:7.9,hp:7900,count:'18%',rewards:{atk:1.3,old:3.6,arm:0.09},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'rusted_templar',name:'RUSTED TEMPLAR',tag:'Faith corroded the armor.',atk:210,def:8.2,hp:8200,count:null,rewards:{old:3.8,bronze:1.4},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'ironblight_monk',name:'IRONBLIGHT MONK',tag:'Discipline turned inward, then rotten.',atk:221,def:8.5,hp:8500,count:3,rewards:{atk:1.4,old:4.0,arm:0.1},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'crypt_sentinel',name:'CRYPT SENTINEL',tag:'Never told the war ended.',atk:231,def:8.8,hp:8800,count:'20%',rewards:{old:4.2,bronze:1.6},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'void_hound',name:'VOID HOUND',tag:'Trained to hunt the living.',atk:241,def:9.1,hp:9100,count:null,rewards:{atk:1.5,old:4.4,arm:0.11},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'soulless_pikeman',name:'SOULLESS PIKEMAN',tag:'The point is the only thing left.',atk:251,def:9.4,hp:9400,count:5,rewards:{old:4.6,bronze:1.8},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'charnel_blade',name:'CHARNEL BLADE',tag:'The sword came first; the corpse second.',atk:261,def:9.7,hp:9700,count:'22%',rewards:{atk:1.6,old:4.8,arm:0.12},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'flayed_scout',name:'FLAYED SCOUT',tag:'Reconnaissance at any cost.',atk:271,def:10.0,hp:10000,count:null,rewards:{old:5.0,bronze:2.0},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'worm_priest',name:'WORM PRIEST',tag:'The congregation answers.',atk:282,def:10.4,hp:10300,count:2,rewards:{atk:1.7,old:5.2,arm:0.13},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'ashgrave_guardian',name:'ASHGRAVE GUARDIAN',tag:'Nothing to guard. Still guarding.',atk:292,def:10.7,hp:10600,count:'25%',rewards:{old:5.4,bronze:2.2},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'mournful_specter',name:'MOURNFUL SPECTER',tag:'The grief is the danger.',atk:302,def:11.0,hp:10900,count:null,rewards:{atk:1.8,old:5.6,arm:0.14},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'marrow_stalker',name:'MARROW STALKER',tag:'It wants what is inside.',atk:312,def:11.3,hp:11200,count:4,rewards:{old:5.8,bronze:2.4},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'duskblade_revenant',name:'DUSKBLADE REVENANT',tag:'Returned with interest.',atk:322,def:11.6,hp:11500,count:'28%',rewards:{atk:1.9,old:6.0,arm:0.15},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'smoldering_footman',name:'SMOLDERING FOOTMAN',tag:'On fire. Still reporting.',atk:333,def:12.0,hp:11800,count:null,rewards:{old:6.2,bronze:2.6},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'blight_ranger',name:'BLIGHT RANGER',tag:'Tracking the living.',atk:343,def:12.3,hp:12100,count:3,rewards:{atk:2.0,old:6.4,arm:0.16},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'accursed_legionnaire',name:'ACCURSED LEGIONNAIRE',tag:'The legion marched on without orders.',atk:353,def:12.6,hp:12400,count:'30%',rewards:{old:6.6,bronze:2.8},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'dead_eye_marksman',name:'DEAD EYE MARKSMAN',tag:'The eye was the last thing to go.',atk:363,def:12.9,hp:12700,count:null,rewards:{atk:2.1,old:6.8,arm:0.17},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'tomb_warden',name:'TOMB WARDEN',tag:'The tomb is wherever it stands.',atk:373,def:13.2,hp:13000,count:5,rewards:{old:7.0,bronze:3.0},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'sable_crow',name:'SABLE CROW',tag:'Circles everything it intends to ruin.',atk:383,def:13.5,hp:13300,count:'32%',rewards:{atk:2.2,old:7.2,arm:0.18},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'ironrot_berserker',name:'IRONROT BERSERKER',tag:'Anger was the last thing preserved.',atk:394,def:13.9,hp:13600,count:null,rewards:{old:7.4,bronze:3.2},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'plague_monk',name:'PLAGUE MONK',tag:'Spreading the doctrine.',atk:404,def:14.2,hp:13900,count:2,rewards:{atk:2.3,old:7.6,arm:0.19},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'blighted_squire',name:'BLIGHTED SQUIRE',tag:'The knighthood never came.',atk:414,def:14.5,hp:14200,count:'35%',rewards:{old:7.8,bronze:3.4},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'hollow_cavalier',name:'HOLLOW CAVALIER',tag:'The horse is gone. It still rides.',atk:424,def:14.8,hp:14500,count:null,rewards:{atk:2.4,old:8.0,arm:0.2},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'gravebound_duelist',name:'GRAVEBOUND DUELIST',tag:'An honor bound to the wrong world.',atk:434,def:15.1,hp:14700,count:4,rewards:{old:8.2,bronze:3.6},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'withered_inquisitor',name:'WITHERED INQUISITOR',tag:'The questions never stopped.',atk:445,def:15.5,hp:15000,count:'38%',rewards:{atk:2.5,old:8.4,arm:0.21},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'shroud_knight',name:'SHROUD KNIGHT',tag:'The burial cloth became the armor.',atk:455,def:15.8,hp:15200,count:null,rewards:{old:8.6,bronze:3.8},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'bone_arbalist',name:'BONE ARBALIST',tag:'The bolts are personal.',atk:465,def:16.1,hp:15500,count:3,rewards:{atk:2.6,old:8.8,arm:0.22},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'ash_zealot',name:'ASH ZEALOT',tag:'Burned for the cause. Returned for more.',atk:475,def:16.4,hp:15700,count:'40%',rewards:{old:9.0,bronze:4.0},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'saltblood_soldier',name:'SALTBLOOD SOLDIER',tag:'Preserved in spite.',atk:485,def:16.7,hp:16000,count:null,rewards:{atk:2.7,old:9.2,arm:0.23},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'dread_footman',name:'DREAD FOOTMAN',tag:'The lowest rank. The worst fate.',atk:496,def:17.1,hp:16300,count:5,rewards:{old:9.4,bronze:4.2},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'ruinborn_warden',name:'RUINBORN WARDEN',tag:'Made from the rubble. Guards the rubble.',atk:506,def:17.4,hp:16600,count:'42%',rewards:{atk:2.8,old:9.6,arm:0.24},vicReq:5,new:false,tier:2,type:'scrap'},
  {id:'forsaken_outrider',name:'FORSAKEN OUTRIDER',tag:'Left behind on purpose.',atk:516,def:17.7,hp:16900,count:null,rewards:{old:9.8,bronze:4.4},vicReq:5,new:false,tier:2,type:'scrap'},
  // ── TIER 3 — RARE ──────────────────────────────────
  {id:'bonegrinder',name:'BONEGRINDER',tag:'The name is the method.',atk:800,def:35,hp:22000,count:null,rewards:{atk:5.0,arm:1.2,old:100},vicReq:5,new:false,tier:3,type:'scrap'},
  {id:'voidborn_witch',name:'VOIDBORN WITCH',tag:'She came from nothing and brought it with her.',atk:850,def:36.5,hp:24000,count:'15%',rewards:{old:120,bronze:20,crc:0.08},vicReq:5,new:false,tier:3,type:'scrap'},
  {id:'weeping_shade',name:'WEEPING SHADE',tag:'The sorrow is the weapon.',atk:900,def:38,hp:26000,count:2,rewards:{atk:5.5,old:140,arm:1.5},vicReq:5,new:false,tier:3,type:'scrap'},
  {id:'soul_eater',name:'SOUL EATER',tag:'Efficient. Thorough. Hungry.',atk:950,def:39.5,hp:28000,count:null,rewards:{old:160,bronze:30,silver:5},vicReq:5,new:false,tier:3,type:'scrap'},
  {id:'dread_colossus',name:'DREAD COLOSSUS',tag:'Too large to comprehend. Too real to ignore.',atk:1000,def:41,hp:30000,count:'18%',rewards:{atk:6.0,arm:2.0,old:180},vicReq:5,new:false,tier:3,type:'scrap'},
  {id:'flesh_sculptor',name:'FLESH SCULPTOR',tag:'It has opinions about your shape.',atk:1050,def:42.5,hp:32000,count:null,rewards:{old:200,bronze:40,silver:7},vicReq:5,new:false,tier:3,type:'scrap'},
  {id:'blighted_hydra',name:'BLIGHTED HYDRA',tag:'Cut one head. Grieve twice.',atk:1100,def:44,hp:34000,count:3,rewards:{atk:6.5,arm:2.5,old:220},vicReq:5,new:false,tier:3,type:'scrap'},
  {id:'pale_stalker',name:'PALE STALKER',tag:'Moving only when unseen.',atk:1150,def:45.5,hp:36000,count:'20%',rewards:{old:240,bronze:50,crc:0.1},vicReq:5,new:false,tier:3,type:'scrap'},
  {id:'abyssal_hound',name:'ABYSSAL HOUND',tag:'Trained in the dark for the dark.',atk:1200,def:47,hp:38000,count:null,rewards:{atk:7.0,arm:3.0,old:260},vicReq:5,new:false,tier:3,type:'scrap'},
  {id:'marrow_golem',name:'MARROW GOLEM',tag:'Built from what the battlefield left over.',atk:1250,def:48.5,hp:40000,count:4,rewards:{old:280,bronze:60,silver:10},vicReq:5,new:false,tier:3,type:'scrap'},
  {id:'gravemind_thrall',name:'GRAVEMIND THRALL',tag:'The grave is the mind now.',atk:1300,def:50,hp:42000,count:'22%',rewards:{atk:7.5,arm:3.5,old:300},vicReq:5,new:false,tier:3,type:'scrap'},
  {id:'soulrend_fiend',name:'SOULREND FIEND',tag:'It tears at something you cannot defend.',atk:1355,def:51.5,hp:44000,count:null,rewards:{old:320,bronze:70,silver:12},vicReq:5,new:false,tier:3,type:'scrap'},
  {id:'crypt_behemoth',name:'CRYPT BEHEMOTH',tag:'The crypt was built around it.',atk:1410,def:53,hp:46000,count:2,rewards:{atk:8.0,arm:4.0,old:340},vicReq:5,new:false,tier:3,type:'scrap'},
  {id:'ashen_revenant',name:'ASHEN REVENANT',tag:'Burned. Returned. Angry.',atk:1465,def:54.5,hp:48000,count:'25%',rewards:{old:360,bronze:80,silver:14},vicReq:5,new:false,tier:3,type:'scrap'},
  {id:'hollow_titan',name:'HOLLOW TITAN',tag:'Enormous. Nothing inside.',atk:1520,def:56,hp:50000,count:null,rewards:{atk:8.5,arm:4.5,old:380},vicReq:5,new:false,tier:3,type:'scrap'},
  {id:'plague_chimera',name:'PLAGUE CHIMERA',tag:'The worst of several things.',atk:1575,def:57.5,hp:52000,count:3,rewards:{old:400,bronze:90,silver:16},vicReq:5,new:false,tier:3,type:'scrap'},
  {id:'bone_leviathan',name:'BONE LEVIATHAN',tag:'It surfaces when hope fades.',atk:1630,def:59,hp:54000,count:'28%',rewards:{atk:9.0,arm:5.0,old:420},vicReq:5,new:false,tier:3,type:'scrap'},
  {id:'wretched_oracle',name:'WRETCHED ORACLE',tag:'It knows. It does not care.',atk:1685,def:60.5,hp:56000,count:null,rewards:{old:440,bronze:100,silver:18},vicReq:5,new:false,tier:3,type:'scrap'},
  {id:'dusk_warden',name:'DUSK WARDEN',tag:'Protecting the threshold between worlds.',atk:1740,def:62,hp:58000,count:4,rewards:{atk:9.5,arm:5.5,old:460},vicReq:5,new:false,tier:3,type:'scrap'},
  {id:'voidtouched_wraith',name:'VOIDTOUCHED WRAITH',tag:'The void left fingerprints.',atk:1795,def:63.5,hp:60000,count:'30%',rewards:{old:480,bronze:110,silver:20},vicReq:5,new:false,tier:3,type:'scrap'},
  {id:'ironblight_giant',name:'IRONBLIGHT GIANT',tag:'Rust and contempt made flesh.',atk:1850,def:65,hp:62000,count:null,rewards:{atk:10.0,arm:6.0,old:500},vicReq:5,new:false,tier:3,type:'scrap'},
  {id:'charnel_hydra',name:'CHARNEL HYDRA',tag:'Each head remembers a different death.',atk:1905,def:66.5,hp:64000,count:2,rewards:{old:520,bronze:120,silver:22},vicReq:5,new:false,tier:3,type:'scrap'},
  {id:'nightmare_shade',name:'NIGHTMARE SHADE',tag:'It is what you fear it to be.',atk:1960,def:68,hp:66000,count:'32%',rewards:{atk:10.5,arm:6.5,old:540},vicReq:5,new:false,tier:3,type:'scrap'},
  {id:'graveworm_matron',name:'GRAVEWORM MATRON',tag:'Mother of what the ground produces.',atk:2015,def:69.5,hp:68000,count:null,rewards:{old:560,bronze:130,silver:24},vicReq:5,new:false,tier:3,type:'scrap'},
  {id:'soul_harvester',name:'SOUL HARVESTER',tag:'Working the final field.',atk:2070,def:71,hp:70000,count:3,rewards:{atk:11.0,arm:7.0,old:580},vicReq:5,new:false,tier:3,type:'scrap'},
  {id:'blighted_cyclops',name:'BLIGHTED CYCLOPS',tag:'One eye. Sees everything.',atk:2125,def:72.5,hp:72000,count:'35%',rewards:{old:600,bronze:140,silver:26},vicReq:5,new:false,tier:3,type:'scrap'},
  {id:'desecrated_giant',name:'DESECRATED GIANT',tag:'The sacred made obscene.',atk:2180,def:74,hp:74000,count:null,rewards:{atk:11.5,arm:7.5,old:620},vicReq:5,new:false,tier:3,type:'scrap'},
  {id:'moonblood_specter',name:'MOONBLOOD SPECTER',tag:'Lunar light brought it here.',atk:2235,def:75.5,hp:76000,count:4,rewards:{old:640,bronze:150,silver:28},vicReq:5,new:false,tier:3,type:'scrap'},
  {id:'gravesinger',name:'GRAVESINGER',tag:'The song is the sentence.',atk:2290,def:77,hp:78000,count:'38%',rewards:{atk:12.0,arm:8.0,old:660},vicReq:5,new:false,tier:3,type:'scrap'},
  {id:'blight_behemoth',name:'BLIGHT BEHEMOTH',tag:'Slow. Absolute.',atk:2345,def:78.5,hp:80000,count:null,rewards:{old:680,bronze:160,silver:30},vicReq:5,new:false,tier:3,type:'scrap'},
  // ── TIER 4 — EPIC ──────────────────────────────────
  {id:'lich_sovereign',name:'LICH SOVEREIGN',tag:'Death is a promotion.',atk:2800,def:95,hp:80000,count:null,rewards:{atk:20,arm:8,old:1000,bronze:300},vicReq:5,new:false,tier:4,type:'elite'},
  {id:'ashen_seraph',name:'ASHEN SERAPH',tag:'Holy war, concluded badly.',atk:3000,def:100,hp:88000,count:'20%',rewards:{old:1200,bronze:380,silver:40},vicReq:5,new:false,tier:4,type:'elite'},
  {id:'dread_overlord',name:'DREAD OVERLORD',tag:'Command without a kingdom left.',atk:3200,def:105,hp:96000,count:4,rewards:{atk:22,arm:10,old:1400,bronze:450},vicReq:5,new:false,tier:4,type:'elite'},
  {id:'plague_archon',name:'PLAGUE ARCHON',tag:'The authority of disease.',atk:3400,def:110,hp:104000,count:null,rewards:{old:1600,bronze:520,silver:55,mxd:0.5},vicReq:5,new:false,tier:4,type:'elite'},
  {id:'voidborn_tyrant',name:'VOIDBORN TYRANT',tag:'Rulership learned from nothing.',atk:3600,def:115,hp:112000,count:'25%',rewards:{atk:25,arm:12,old:1800,bronze:600},vicReq:5,new:false,tier:4,type:'elite'},
  {id:'hollow_god_husk',name:'HOLLOW GOD-HUSK',tag:'Something divine was here.',atk:3800,def:120,hp:120000,count:null,rewards:{old:2000,bronze:680,silver:70,mxd:0.7},vicReq:5,new:false,tier:4,type:'elite'},
  {id:'soulweaver_ancient',name:'SOULWEAVER ANCIENT',tag:'It has been weaving since before you.',atk:4000,def:128,hp:128000,count:3,rewards:{atk:28,arm:14,old:2200,bronze:760},vicReq:5,new:false,tier:4,type:'elite'},
  {id:'desecrated_archangel',name:'DESECRATED ARCHANGEL',tag:'The fall was not an accident.',atk:4200,def:135,hp:136000,count:'30%',rewards:{old:2400,bronze:840,silver:85,crc:0.2},vicReq:5,new:false,tier:4,type:'elite'},
  {id:'bonelord_eternal',name:'BONELORD ETERNAL',tag:'Has not stopped since it began.',atk:4400,def:142,hp:144000,count:null,rewards:{atk:32,arm:16,old:2600,bronze:920},vicReq:5,new:false,tier:4,type:'elite'},
  {id:'maelstrom_wraith',name:'MAELSTROM WRAITH',tag:'The storm learned to hate.',atk:4600,def:149,hp:152000,count:5,rewards:{old:2800,bronze:1000,silver:100,mxd:0.9},vicReq:5,new:false,tier:4,type:'elite'},
  {id:'abyssal_monarch',name:'ABYSSAL MONARCH',tag:'Crowned in the deepest dark.',atk:4800,def:157,hp:160000,count:'35%',rewards:{atk:36,arm:18,old:3000,bronze:1100},vicReq:5,new:false,tier:4,type:'elite'},
  {id:'gravemind_elder',name:'GRAVEMIND ELDER',tag:'The oldest thought in the graveyard.',atk:5000,def:164,hp:168000,count:null,rewards:{old:3200,bronze:1200,silver:120,crc:0.3},vicReq:5,new:false,tier:4,type:'elite'},
  {id:'bloodbound_colossus',name:'BLOODBOUND COLOSSUS',tag:'Held together by a pact and old blood.',atk:5200,def:171,hp:176000,count:2,rewards:{atk:40,arm:20,old:3400,bronze:1300},vicReq:5,new:false,tier:4,type:'elite'},
  {id:'cursed_demigod',name:'CURSED DEMIGOD',tag:'Half divine, fully damned.',atk:5400,def:178,hp:184000,count:'40%',rewards:{old:3600,bronze:1400,silver:140,mxd:1.2},vicReq:5,new:false,tier:4,type:'elite'},
  {id:'pale_dominion',name:'PALE DOMINION',tag:'Sovereignty over nothing living.',atk:5600,def:185,hp:192000,count:null,rewards:{atk:44,arm:22,old:3800,bronze:1500},vicReq:5,new:false,tier:4,type:'elite'},
  {id:'hollow_primarch',name:'HOLLOW PRIMARCH',tag:'The first of a lineage of ruin.',atk:5800,def:192,hp:200000,count:4,rewards:{old:4000,bronze:1600,silver:160,crc:0.4},vicReq:5,new:false,tier:4,type:'elite'},
  {id:'forsaken_titan',name:'FORSAKEN TITAN',tag:'Abandoned by the age that made it.',atk:6000,def:200,hp:210000,count:'45%',rewards:{atk:48,arm:24,old:4200,bronze:1700},vicReq:5,new:false,tier:4,type:'elite'},
  {id:'sorrow_sovereign',name:'SORROW SOVEREIGN',tag:'Rules only what it has destroyed.',atk:6200,def:207,hp:220000,count:null,rewards:{old:4400,bronze:1800,silver:180,mxd:1.5},vicReq:5,new:false,tier:4,type:'elite'},
  {id:'shattered_deity',name:'SHATTERED DEITY',tag:'The pieces are still dangerous.',atk:6500,def:215,hp:230000,count:3,rewards:{atk:52,arm:26,old:4700,bronze:1900},vicReq:5,new:false,tier:4,type:'elite'},
  {id:'ironblight_colossus',name:'IRONBLIGHT COLOSSUS',tag:'Corroded past the point of stopping.',atk:6800,def:222,hp:240000,count:'50%',rewards:{old:5000,bronze:2000,silver:200,crc:0.5,mxd:1.8},vicReq:5,new:false,tier:4,type:'elite'},
  // ── TIER 5 — LEGENDARY ─────────────────────────────
  {id:'the_devourer',name:'THE DEVOURER',tag:'It has always been eating.',atk:8000,def:230,hp:260000,count:null,rewards:{atk:80,arm:30,old:8000,bronze:3000,silver:250},vicReq:5,new:false,tier:5,type:'elite'},
  {id:'nameless_king',name:'NAMELESS KING',tag:'The name was the last thing surrendered.',atk:9333,def:258,hp:300000,count:'30%',rewards:{old:12000,bronze:4500,silver:350,mxd:2.0,crc:0.6},vicReq:5,new:false,tier:5,type:'elite'},
  {id:'he_who_unravels',name:'HE WHO UNRAVELS',tag:'Everything comes apart near him.',atk:10667,def:285,hp:340000,count:4,rewards:{atk:110,arm:40,old:18000,bronze:6500},vicReq:5,new:false,tier:5,type:'elite'},
  {id:'throne_of_ash',name:'THRONE OF ASH',tag:'Power without a king. Worse.',atk:12000,def:313,hp:380000,count:null,rewards:{old:25000,bronze:9000,silver:500,mxd:2.5,crc:0.7},vicReq:5,new:false,tier:5,type:'elite'},
  {id:'the_pale_hunger',name:'THE PALE HUNGER',tag:'It was not born. It grew.',atk:13333,def:340,hp:400000,count:'40%',rewards:{atk:140,arm:50,old:35000,bronze:12000,silver:600},vicReq:5,new:false,tier:5,type:'elite'},
  {id:'godrot',name:'GODROT',tag:'Even gods decompose.',atk:14667,def:368,hp:430000,count:null,rewards:{old:48000,bronze:16000,silver:750,mxd:3.0,crc:0.8},vicReq:5,new:false,tier:5,type:'elite'},
  {id:'the_unfinished',name:'THE UNFINISHED',tag:'Incomplete. Unstoppable.',atk:16000,def:395,hp:460000,count:5,rewards:{atk:170,arm:60,old:65000,bronze:22000,silver:900},vicReq:5,new:false,tier:5,type:'elite'},
  {id:'womb_of_plague',name:'WOMB OF PLAGUE',tag:'The source, not the symptom.',atk:17333,def:423,hp:490000,count:null,rewards:{old:85000,bronze:30000,silver:1100,mxd:3.5,crc:0.9},vicReq:5,new:false,tier:5,type:'elite'},
  {id:'bleeding_throne',name:'BLEEDING THRONE',tag:'Sovereignty at a cost.',atk:18667,def:450,hp:500000,count:'50%',rewards:{atk:200,arm:75,old:110000,bronze:40000,silver:1300,mxd:4.0},vicReq:5,new:false,tier:5,type:'elite'},
  {id:'the_hollow_crown',name:'THE HOLLOW CROWN',tag:'All that remains of what ruled.',atk:20000,def:480,hp:550000,count:null,rewards:{atk:250,arm:100,old:150000,bronze:60000,silver:2000,mxd:5.0,crc:1.0,apn:10},vicReq:5,new:false,tier:5,type:'boss'},
];
...
const SHOP_ITEMS = [
  ...
  {id:'charcoal_blade',name:'CHARCOAL BLADE',desc:'Smudges enemies into submission.',effect:'ATK +10, APN +0.5',cost:{old:200,silver:5},statBonus:{atk:10,apn:0.5}},
  ...
  // Tier 2 Shop
  {id:'wax_tablet',name:'WAX TABLET',desc:'Ancient storage, modern power.',effect:'MND +5%, APN +1',cost:{old:500,bronze:50},statBonus:{mnd:0.05,apn:1}},
  ...
  {id:'master_palette',name:'MASTER PALETTE',desc:'Every color of pain.',effect:'ATK +80, APN +2',cost:{old:6000,bronze:800},statBonus:{atk:80,apn:2}},
...
const ACHIEVEMENTS = [
  ...
  // ── RESOURCES ────────────────────────────────────────
  {id:'gra_1k',         name:'INK STAINED',        desc:'Accumulate 1,000 Graphite.',          icon:'▲',  cat:'resources',   check:s=>s.lifeOld>=1000},
  {id:'gra_100k',       name:'GRAPHITE HOARD',     desc:'Accumulate 100,000 Graphite lifetime.',icon:'◆', cat:'resources',   check:s=>s.lifeOld>=100000},
  // ── META ──────────────────────────────────────────────
...
// ═══════════════════════════════════════════════════════
const DEFAULT_STATE = ()=>({
  stats:{hp:50,atk:3,mnd:0.7,mxd:1.2,spd:100,rgn:0,dog:0,crc:0,crd:1.0,arm:0,apn:1.0,armp:0,mth:0,acc:1.0,blk:0,bld:0,ctr:0},
...
const STAT_DEFS=[
  ...
  {key:'armp',label:'ARMP',icon:'si-armp',cat:'offense',fmt:'n'},
...
function renderGallery(){
  ...
  html+=visible.map(c=>{
    ...
    const rewardStr=Object.entries(c.rewards).map(([k,v])=>`<span class="reward-item ${['old','bronze','silver'].includes(k)?'res':''}">${k.toUpperCase()} +${v}</span>`).join('');
...
function onWin(){
  ...
  const oldGain=(5+Math.random()*3)*tierBonus;
  S.resources.old+=oldGain;
  S.lifeOld=(S.lifeOld||0)+oldGain;
  checkAchievements();
...
function synthTick(dt){
  ...
  const silverRate=S.resources.gold*0.002;
  const bronzeRate=S.resources.silver*0.002;
  const oldRate=S.resources.bronze*0.005;
...
function loadGame(){
  try{
    ...
    if(offline>10){
      ...
      setTimeout(()=>toast(`Welcome back! +${fmt(offlineOld)} Old Coin, +${fmt(offlineBronze)} Bronze Coin offline (${fmtTime(offline)})`,5000),500);
    }
