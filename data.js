...
const CREATURES = [
  ...
  {id:'bonepicker',name:'BONEPICKER',
    hp:25,atk:6,mnd:0.7,mxd:1.2,spd:2500,rgn:0,ddc:0,crc:0,crd:0,arm:0,mth:0,acc:0,ctr:0,
  ...
  {id:'grave_rat',name:'GRAVE RAT',
    hp:20,atk:8,mnd:0.7,mxd:1.2,spd:1500,rgn:0,ddc:0,crc:0,crd:0,arm:0,mth:0,acc:0,ctr:0,
    rewards:{spd:-40,atk:5,old:40},
    vicReq:2,
    img:'attached_assets/img/creature/5grave_rat.png'},
  {id:'mudborn',name:'MUDBORN',
    hp:50,atk:15,mnd:0.7,mxd:1.2,spd:4000,rgn:0,ddc:0,crc:0,crd:0,arm:2,mth:0,acc:0,ctr:0,
    rewards:{atk:7,hp:20,old:60},
    vicReq:2,
    img:'attached_assets/img/creature/6mudborn.png'},
  {id:'corpse_crawler',name:'CORPSE CRAWLER',
    hp:80,atk:20,mnd:0.7,mxd:1.2,spd:3000,rgn:1,ddc:0,crc:0,crd:0,arm:5,mth:0,acc:0,ctr:0,
    rewards:{hp:20,arm:1,old:80},
    vicReq:2,
    img:'attached_assets/img/creature/7corpse_crawler.png'},
  {id:'rotting_serf',name:'ROTTING SERF',
    hp:100,atk:20,mnd:0.7,mxd:1.2,spd:2000,rgn:1,ddc:0,crc:0,crd:0,arm:0,mth:0,acc:0,ctr:0,
  ...
  {id:'blighted_husk',name:'BLIGHTED HUSK',
    hp:100,atk:20,mnd:0.7,mxd:1.2,spd:1500,rgn:1,ddc:0,crc:0,crd:0,arm:5,mth:0,acc:0,ctr:0,
    rewards:{hp:10,atk:10,old:200},
    vicReq:2,
    img:'attached_assets/img/creature/9blighted_husk.png'},
  {id:'soot_fiend',name:'SOOT FIEND',
    hp:160,atk:30,mnd:0.7,mxd:1.2,spd:2500,rgn:0,ddc:0,crc:0,crd:0,arm:5,mth:0,acc:0,ctr:0,
    rewards:{atk:15,old:300},
    vicReq:2,
    img:'attached_assets/img/creature/10soot_fiend.png'},
  {id:'wretched_thrall',name:'WRETCHED THRALL',
    hp:200,atk:40,mnd:0.7,mxd:1.2,spd:3000,rgn:0,ddc:0,crc:0,crd:0,arm:5,mth:0,acc:0,ctr:0,
    rewards:{hp:30,old:500},
    vicReq:2,
    img:'attached_assets/img/creature/11wretched_thrall.png'},
  {id:'festering_vagrant',name:'FESTERING VAGRANT',
    hp:400,atk:50,mnd:1,mxd:1.4,spd:5000,rgn:0,ddc:0,crc:0,crd:0,arm:5,mth:0,acc:0,ctr:0,
  ...
  {id:'hollow_eye',name:'HOLLOW EYE',
    hp:600,atk:30,mnd:1,mxd:1.4,spd:1000,rgn:0,ddc:0,crc:0,crd:0,arm:10,mth:0,acc:0,ctr:0,
  ...
  {id:'dungeon_tick',name:'DUNGEON TICK',
    hp:800,atk:50,mnd:1,mxd:1.4,spd:2000,rgn:0,ddc:0,crc:0,crd:0,arm:10,mth:0,acc:0,ctr:0,
  ...
  {id:'gravel_ghoul',name:'GRAVEL GHOUL',
    hp:300,atk:25,mnd:1,mxd:1.4,spd:2500,rgn:0,ddc:0,crc:0,crd:0,arm:10,mth:0,acc:0,ctr:0,
    rewards:{atk:5,hp:20,old:400,bronze:40},
    vicReq:2,
    img:'attached_assets/img/creature/15gravel_ghoul.png'},
  {id:'bile_spawn',name:'BILE SPAWN',
    hp:333,atk:33,mnd:1,mxd:1.4,spd:3333,rgn:0,ddc:0,crc:0,crd:0,arm:10,mth:0,acc:0,ctr:0,
